...
weather_schema = StructType([
    StructField("coord", StructType([
        StructField("lon", FloatType(), False), #Should not be null
        StructField("lat", FloatType(), False)#Should not be null
    ]), True),
    ...
    StructField("main", StructType([
        StructField("temp", FloatType(), False), #Should not be null
    ...
    StructField("dt", IntegerType(), False), #Should not be null
...
weather_df = weather_df.filter(
    (col("weather_data.coord.lon").isNotNull()) &
    (col("weather_data.coord.lat").isNotNull()) &
    (col("weather_data.main.temp").isNotNull()) &
    (col("weather_data.dt").isNotNull())
)
